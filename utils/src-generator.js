...
const generateSrc = (projectPath) => {
  execSync(`mkdir src`);
  execSync(`mkdir ${path.join("src", "assets")}`);
  fs.writeFileSync(
...
.danugarri {
    ...
    animation: danugarri-animation infinite 5s linear;
    position: relative;
}
@keyframes logo-spin {
    from {
      ...
      return (
          <div className="App">
              ...
              <h2 className="">
                  ...
                  <h3>
                      <a
                          href="https://www.linkedin.com/in/daniel-garrido-lizana/"
                          target="_blank"
                          rel="noreferrer"
                          className="danugarri"
                      >
